...
class PaypalMasspayNotificationTest < Test::Unit::TestCase
  ...
  def test_subpayment_status_mapping
    assert_equal "Completed", @paypal.payments[0].status
    assert_equal "Unclaimed", @paypal.payments[1].status
  end
